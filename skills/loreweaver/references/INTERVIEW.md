...
- `base.s4.q12`: "Any data contracts or schemas it must honor? Name them, or `OPEN:` if unknown. Do not
...
- `base.s5b.q15c`: **Auth-gated source:** "I can't reach that behind a login, so please **extract and
